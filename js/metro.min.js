var sUserAgent = navigator.userAgent;if (sUserAgent.indexOf("Windows NT 5.1") > -1|| sUserAgent.indexOf("Windows Xp") > -1) {alert("你仍然在使用落后的Windows XP操作系统，在你升级操作系统前将不能打开此页面。如果你认为识别有误，请联系管理员。");window.opener = null;window.open('', '_self');window.close();}
